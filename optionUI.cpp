...
ID3D11VertexShader*			OptionUI::m_VertexShader = NULL;
ID3D11PixelShader*			OptionUI::m_PixelShader = NULL;
ID3D11InputLayout*			OptionUI::m_VertexLayout = NULL;

ID3D11Buffer*				OptionUI::m_VertexBuffer = NULL;
ID3D11ShaderResourceView*	OptionUI::m_Texture = NULL;
...
void OptionUI::Init()
{
	...
	D3DX11CreateShaderResourceViewFromFile(Renderer::GetDevice(),
		"asset/texture/optionui.png",//ファイル指定
		NULL,
		NULL,
