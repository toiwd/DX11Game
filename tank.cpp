...
ID3D11Buffer*				Tank::m_VertexBuffer = NULL;
ID3D11ShaderResourceView*	Tank::m_Texture = NULL;
...
void Tank::Load()
{
	...
	//左上
	vertex[0].Position = D3DXVECTOR3(-1.0f, 4.0f, 0.0f);		//描画座標
	...
	//右上
	vertex[1].Position = D3DXVECTOR3(3.0f, 4.0f, 0.0f);
	...
	D3DX11CreateShaderResourceViewFromFile(Renderer::GetDevice(),
		"asset/texture/InkTank.png",//ファイル指定
		NULL,
		NULL,
...
void Tank::Draw()
{
	...
	if (playerstate == true && playerdead == false)
	{
		...
		vertex[0].Position = D3DXVECTOR3(-2.0f, 4.0f, 0.0f);			//描画座標
		vertex[0].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);			//ライティング
		vertex[0].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);	//色
		vertex[0].TexCoord = D3DXVECTOR2(0.0f, 0.0f);				//テクスチャ座標

		vertex[1].Position = D3DXVECTOR3(2.0f, 4.0f, 0.0f);
		vertex[1].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
		vertex[1].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
		vertex[1].TexCoord = D3DXVECTOR2(1.0f, 0.0f);

		vertex[2].Position = D3DXVECTOR3(-2.0f, 0.0f, 0.0f);
		vertex[2].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
		vertex[2].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
		vertex[2].TexCoord = D3DXVECTOR2(0.0f, 1.0f);

		vertex[3].Position = D3DXVECTOR3(2.0f, 0.0f, 0.0f);
		vertex[3].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
